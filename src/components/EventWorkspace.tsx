              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-xs space-y-5">
                  ...
                  <div className="space-y-3 pt-2 border-t border-slate-100">
                    ...
                    {/* Live Stream Room Link */}
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 p-3 rounded-xl bg-sky-50/60 border border-sky-100">
                      <div>
                        <p className="text-xs font-bold text-sky-900">Sala de Transmissão ao Vivo (Participante)</p>
                        <p className="text-[11px] text-sky-600 truncate max-w-sm">{liveUrl}</p>
                      </div>

                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => handleCopy(liveUrl, "live")}
                          className="flex items-center gap-1.5 rounded-lg border border-sky-200 bg-white px-3 py-1.5 text-xs font-bold text-sky-800 hover:bg-sky-50 transition shadow-xs"
                        >
                          {copiedLink === "live" ? (
                            <>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="p-1.5 rounded-lg border border-sky-200 bg-white hover:bg-sky-50 text-sky-600"
