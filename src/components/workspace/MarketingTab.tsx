  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-900 tracking-tight">Automação de E-mails & Lembretes</h2>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 rounded-3xl border border-slate-200/80 bg-white/80 p-4 shadow-xs backdrop-blur-xs">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#00b4fb]/10 text-[#0084be]">
            <Mail className="h-5 w-5" />
          </div>
          <div>
            <p className="text-xs font-bold text-slate-900 tracking-tight">Servidor SMTP Corporativo Conectado</p>
        ...
        <div className="flex items-center gap-2 rounded-2xl bg-slate-50/80 border border-slate-200/70 px-3 py-1.5 text-xs text-slate-700 backdrop-blur-xs">
      ...
      <div className="space-y-3.5">
        {triggers.map((trigger) => (
          <motion.div
            ...
            whileHover={{ y: -1 }}
            transition={springs.snappy}
            className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl border bg-white/80 backdrop-blur-xs p-5 shadow-xs transition ${
              trigger.enabled ? "border-slate-200/80" : "border-slate-200/50 opacity-60 bg-slate-50/50"
            }`}
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-sm font-bold text-slate-900 tracking-tight">{trigger.name}</h3>
                  {trigger.isCustom && (
